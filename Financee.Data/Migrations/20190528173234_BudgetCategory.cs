        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarnerId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Incomes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Incomes_AspNetUsers_EarnerId",
                        column: x => x.EarnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false),
                    Money = table.Column<decimal>(nullable: false),
                    ForWhat = table.Column<string>(nullable: true),
                    SpenderId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenditures_AspNetUsers_SpenderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenditures_BudgetCategoryId",
                table: "Expenditures",
                column: "BudgetCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Expenditures_SpenderId",
                table: "Expenditures",
                column: "SpenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_EarnerId",
                table: "Incomes",
                column: "EarnerId");
        }
